...
##  chr [1:97] "MCM5" "PCNA" "TYMS" "FEN1" "MCM2" "MCM4" "RRM1" "UNG" "GINS2" "MCM6" "CDCA7" "DTL" "PRIM1" "UHRF1" ...
```
...
## Running PCA...
## Running UMAP...
## Running graph-based clustering and DGE...
...
First, we perform 2 dimensional reduction steps, followed by graph-based clustering and differential gene expression analysis to define cluster-specific markers. The specific steps include:
...
4. Performing differential gene expression analysis between the clusters defined in the previous step by calling `Seurat::FindAllMarkers` (only.pos = T, logfc.threshold = 0.5). Results are written in the defined `output.dir` as "DE_perCluster.txt" (this corresponds to Supplementary Table 2)
...
Finally, we assign each cluster to a known cell type. In nearly all cases, this was done through manual examination of differential gene expression analysis per cluster. The exceptions to this are detailed below:
...
Using the final processed object as input, a number of the manuscript figure panels can be reproduced by calling `plot_processed()` and specifying which figure to plot with `figure=""`. By default, the generated plots are sent to the active graphics device for visualization. The output plots can also be saved as pdf files by specifying `save = TRUE` and giving the path to the desired output directory using `save.dir=` (defaults to "."). The accepted figure IDs include: "**2A**", "**2B**", "**2C**", "**ED_3A**", "**ED_3B**", "**ED_4D**", "**ED_4E**" and "**ED_8B**". A description of each output figure can be found in the function documentation (`?plot_processed`).

#### Figure 2A


```r
plot_processed(object = final.output, figure = "2A", save = F, save.dir = ".")
```

<img src="figure/figure_2A-1.png" title="plot of chunk figure_2A" alt="plot of chunk figure_2A" width="60%" height="60%" style="display: block; margin: auto;" />

#### Figure 2B


```r
plot_processed(object = final.output, figure = "2B", save = F, save.dir = ".")
```

<img src="figure/figure_2b-1.png" title="plot of chunk figure_2b" alt="plot of chunk figure_2b" width="60%" height="60%" style="display: block; margin: auto;" />
...
```r
plot_processed(object = final.output, figure = "ED_3A", save = F, save.dir = ".")
```

<img src="figure/ed_figure_3a-1.png" title="plot of chunk ed_figure_3a" alt="plot of chunk ed_figure_3a" width="60%" height="60%" style="display: block; margin: auto;" />

#### Extended data Figure 3B


```r
plot_processed(object = final.output, figure = "ED_3B", save = F, save.dir = ".")
```

<img src="figure/ed_figure_3b-1.png" title="plot of chunk ed_figure_3b" alt="plot of chunk ed_figure_3b" style="display: block; margin: auto;" />

#### Extended data Figure 4D


```r
plot_processed(object = final.output, figure = "ED_4D", save = F, save.dir = ".")
```

<img src="figure/figure_ed_4d-1.png" title="plot of chunk figure_ed_4d" alt="plot of chunk figure_ed_4d" width="60%" height="60%" style="display: block; margin: auto;" />

#### Extended data Figure 4E


```r
plot_processed(object = final.output, figure = "ED_4E", save = F, save.dir = ".")
```

<img src="figure/figure_ed_4e-1.png" title="plot of chunk figure_ed_4e" alt="plot of chunk figure_ed_4e" width="50%" height="50%" style="display: block; margin: auto;" />

#### Extended data Figure 8B


```r
plot_processed(object = final.output, figure = "ED_8B", save = F, save.dir = ".")
```

<img src="figure/figure_ed_8b-1.png" title="plot of chunk figure_ed_8b" alt="plot of chunk figure_ed_8b" width="70%" height="70%" style="display: block; margin: auto;" />
...
The output from `il22_response()` can be used to re-produce the relevant figure panels using the `plot_il22()` function. The accepted figure IDs are: "**2D**", "**3A**", "**ED_8A**", "**ED_9A**" and "**ED_9B**"; a description of each panel can be found in the function documentation (`?plot_il22`). When re-producing figure 2D and extended data figure 8A, the DGE analysis output file (full data set) from `il22_response()` ("*DE_IL22.txt"*) needs to be specified using `dge.output=`. As with the other plotting functions, the generated plots are sent by default to the active graphics device for visualization, but can also be saved as pdf files by specifying `save = TRUE` and giving the path to the desired output directory using `save.dir=` (defaults to ".").
...
```r
plot_il22(object = il22.output.obj, figure = "3A", save = F, save.dir = ".")
```

<img src="figure/figure_3A-1.png" title="plot of chunk figure_3A" alt="plot of chunk figure_3A" width="70%" height="70%" style="display: block; margin: auto;" />

##### Extended data Figure 8A


```r
plot_il22(object = il22.output.obj, figure = "ED_8A", dge.output = "DE_IL22.txt", save = F, save.dir = ".")
```

<img src="figure/figure_ed_8a-1.png" title="plot of chunk figure_ed_8a" alt="plot of chunk figure_ed_8a" style="display: block; margin: auto;" />

##### Extended data Figure 9A


```r
plot_il22(object = il22.output.obj, figure = "ED_9A", save = F, save.dir = ".")
```

<img src="figure/figure_ed_9a-1.png" title="plot of chunk figure_ed_9a" alt="plot of chunk figure_ed_9a" style="display: block; margin: auto;" />

##### Extended data Figure 9B


```r
plot_il22(object = il22.output.obj, figure = "ED_9B", save = F, save.dir = ".")
```

<img src="figure/figure_ed_9b-1.png" title="plot of chunk figure_ed_9b" alt="plot of chunk figure_ed_9b" width="70%" height="70%" style="display: block; margin: auto;" />
...
The outputs from `model_diffusion()` and `model_slingshot()` can be used to re-produce the relevant figure panels using the `plot_trajectory()` function. The accepted figure IDs are: "**ED_4B**" and "**ED_4C**"; a description of each panel can be found in the function documentation (`?plot_trajectory`). As with the other plotting functions, the generated plots are sent to the active graphics device by default for visualization, but can also be saved as pdf files by specifying `save = TRUE` and giving the path to the desired output directory using `save.dir=` (defaults to ".").

##### Extended data Figure 4B


```r
plot_trajectory(seurat.obj = diffusion.output, slingshot.obj = slingshot.output, figure = "ED_4B",
    save = F, save.dir = ".")
```

<img src="figure/ed_figure_4b-1.png" title="plot of chunk ed_figure_4b" alt="plot of chunk ed_figure_4b" style="display: block; margin: auto;" />

##### Extended data Figure 4C


```r
plot_trajectory(seurat.obj = diffusion.output, slingshot.obj = slingshot.output, figure = "ED_4C",
    save = F, save.dir = ".")
```

<img src="figure/ed_figure_4c-1.png" title="plot of chunk ed_figure_4c" alt="plot of chunk ed_figure_4c" style="display: block; margin: auto;" />
...
scv.pl.velocity_embedding_grid(adata, basis="umap",color="Final.IDS",arrow_size=2,
                              ...
                              palette=["#006F3C","#CB157C","#33AD75","#254B95","#8b8c89",
                               ...
                               size=35,title="",save="Extended_Data_Fig_4a.pdf")
```
...
![](figure/Extended_Data_Fig_4a.png){width="600"}
...
## [1] PanethAnalysis_0.2.0 org.Hs.eg.db_3.13.0  AnnotationDbi_1.54.1 IRanges_2.26.0       S4Vectors_0.30.0    
## [6] Biobase_2.52.0       BiocGenerics_0.38.0 
## 
## loaded via a namespace (and not attached):
##   [1] ggthemes_4.2.4              scattermore_0.7             princurve_2.1.6             SeuratObject_4.0.2         
##   [5] tidyr_1.1.3                 ggplot2_3.3.5               bit64_4.0.5                 knitr_1.33                 
##   [9] irlba_2.3.3                 DelayedArray_0.18.0         data.table_1.14.0           rpart_4.1-15               
##  [13] TrajectoryUtils_1.0.0       KEGGREST_1.32.0             RCurl_1.98-1.3              generics_0.1.0             
##  [17] callr_3.7.0                 cowplot_1.1.1               usethis_2.1.3               RSQLite_2.2.7              
##  [21] shadowtext_0.0.8            RANN_2.6.1                  commonmark_1.7              proxy_0.4-26               
##  [25] future_1.21.0               bit_4.0.4                   enrichplot_1.12.2           xml2_1.3.2                 
##  [29] spatstat.data_2.1-0         httpuv_1.6.1                SummarizedExperiment_1.22.0 assertthat_0.2.1           
##  [33] viridis_0.6.1               xfun_0.24                   jquerylib_0.1.4             hms_1.1.0                  
##  [37] evaluate_0.14               promises_1.2.0.1            DEoptimR_1.0-9              fansi_0.5.0                
##  [41] readxl_1.3.1                igraph_1.2.6                DBI_1.1.1                   htmlwidgets_1.5.3          
##  [45] spatstat.geom_2.2-2         purrr_0.3.4                 ellipsis_0.3.2              RSpectra_0.16-0            
##  [49] dplyr_1.0.7                 backports_1.2.1             sparseMatrixStats_1.4.0     deldir_0.2-10              
##  [53] MatrixGenerics_1.4.3        vctrs_0.3.8                 SingleCellExperiment_1.14.1 ggalluvial_0.12.3          
##  [57] Cairo_1.5-12.2              SeuratDisk_0.0.0.9019       TTR_0.24.2                  remotes_2.4.0              
##  [61] ROCR_1.0-11                 abind_1.4-5                 cachem_1.0.5                RcppEigen_0.3.3.9.1        
##  [65] withr_2.4.2                 ggforce_0.3.3               robustbase_0.93-8           vcd_1.4-8                  
##  [69] checkmate_2.0.0             sctransform_0.3.2           treeio_1.16.1               xts_0.12.1                 
##  [73] prettyunits_1.1.1           goftest_1.2-2               cluster_2.1.2               DOSE_3.18.1                
##  [77] ape_5.5                     lazyeval_0.2.2              laeken_0.5.1                crayon_1.4.1               
##  [81] hdf5r_1.3.3                 labeling_0.4.2              pkgconfig_2.0.3             tweenr_1.0.2               
##  [85] GenomeInfoDb_1.28.1         nlme_3.1-152                pkgload_1.2.1               nnet_7.3-16                
##  [89] devtools_2.4.2              rlang_0.4.11                globals_0.14.0              lifecycle_1.0.0            
##  [93] miniUI_0.1.1.1              downloader_0.4              cellranger_1.1.0            rprojroot_2.0.2            
##  [97] polyclip_1.10-0             RcppHNSW_0.3.0              matrixStats_0.61.0          lmtest_0.9-38              
## [101] Matrix_1.3-4                aplot_0.0.6                 carData_3.0-4               boot_1.3-28                
## [105] zoo_1.8-9                   base64enc_0.1-3             ggridges_0.5.3              processx_3.5.2             
## [109] png_0.1-7                   viridisLite_0.4.0           knn.covertree_1.0           bitops_1.0-7               
## [113] KernSmooth_2.23-20          Biostrings_2.60.1           DelayedMatrixStats_1.14.3   blob_1.2.1                 
## [117] stringr_1.4.0               qvalue_2.24.0               slingshot_2.0.0             parallelly_1.26.1          
## [121] jpeg_0.1-8.1                scales_1.1.1                hexbin_1.28.2               memoise_2.0.0              
## [125] magrittr_2.0.1              plyr_1.8.6                  ica_1.0-2                   zlibbioc_1.38.0            
## [129] compiler_4.1.0              scatterpie_0.1.6            RColorBrewer_1.1-2          pcaMethods_1.84.0          
## [133] fitdistrplus_1.1-5          cli_3.1.0                   XVector_0.32.0              listenv_0.8.0              
## [137] patchwork_1.1.1             pbapply_1.4-3               ps_1.6.0                    formatR_1.11               
## [141] htmlTable_2.2.1             Formula_1.2-4               ggplot.multistats_1.0.0     MASS_7.3-54                
## [145] mgcv_1.8-36                 tidyselect_1.1.1            forcats_0.5.1               stringi_1.6.2              
## [149] highr_0.9                   yaml_2.2.1                  GOSemSim_2.18.0             latticeExtra_0.6-29        
## [153] ggrepel_0.9.1               grid_4.1.0                  sass_0.4.0                  fastmatch_1.1-0            
## [157] tools_4.1.0                 rio_0.5.27                  future.apply_1.7.0          rstudioapi_0.13            
## [161] foreign_0.8-81              gridExtra_2.3               smoother_1.1                scatterplot3d_0.3-41       
## [165] farver_2.1.0                Rtsne_0.15                  ggraph_2.0.5                digest_0.6.27              
## [169] rvcheck_0.1.8               BiocManager_1.30.16         shiny_1.6.0                 Rcpp_1.0.7                 
## [173] GenomicRanges_1.44.0        car_3.0-11                  later_1.2.0                 RcppAnnoy_0.0.18           
## [177] httr_1.4.2                  colorspace_2.0-2            ranger_0.12.1               fs_1.5.0                   
## [181] tensor_1.5                  reticulate_1.20             splines_4.1.0               uwot_0.1.10                
## [185] tidytree_0.3.4              spatstat.utils_2.2-0        graphlayouts_0.7.1          sp_1.4-5                   
## [189] plotly_4.9.4.1              sessioninfo_1.1.1           xtable_1.8-4                jsonlite_1.7.2             
## [193] ggtree_3.0.2                tidygraph_1.2.0             testthat_3.0.4              destiny_3.1.1              
## [197] R6_2.5.0                    Hmisc_4.5-0                 pillar_1.6.1                htmltools_0.5.1.1          
## [201] mime_0.11                   glue_1.4.2                  fastmap_1.1.0               clusterProfiler_4.0.2      
## [205] VIM_6.1.0                   BiocParallel_1.26.1         class_7.3-19                codetools_0.2-18           
## [209] fgsea_1.18.0                pkgbuild_1.2.0              utf8_1.2.1                  bslib_0.2.5.1              
## [213] lattice_0.20-44             spatstat.sparse_2.0-0       tibble_3.1.2                curl_4.3.2                 
## [217] leiden_0.3.8                zip_2.2.0                   openxlsx_4.2.4              GO.db_3.13.0               
## [221] limma_3.48.3                roxygen2_7.1.1              survival_3.2-11             rmarkdown_2.9              
## [225] desc_1.4.0                  munsell_0.5.0               e1071_1.7-7                 DO.db_2.9                  
## [229] GenomeInfoDbData_1.2.6      haven_2.4.1                 reshape2_1.4.4              gtable_0.3.0               
## [233] spatstat.core_2.2-0         Seurat_4.0.3
```
