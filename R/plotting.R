...
#'   colored by culture condition (IL22+/IL22-) \item \strong{Extended data Figure 8B}: UMAP plots
...
#'   "2B", "2C", "ED_3A", "ED_3B", "ED_4D" and "ED_8B" (See Details for
...
plot_processed <- function(object=NULL, figure=NA, save=FALSE, save.dir="."){
  ...
  # Check inputs
  accept.figs <- c("2A","2B","2C","ED_3A","ED_3B","ED_4D","ED_8B")
