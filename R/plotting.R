...
#'   culture condition (IL22+/IL22-) \item \strong{Extended data Figure 8B}: UMAP plots
...
#'   "1H", "2C", "S2A", "S2B", "S6A", "S6B" and "ED_8B" (See Details for
...
plot_processed <- function(object=NULL, figure=NA, save=FALSE, save.dir="."){
  ...
  # Check inputs
  accept.figs <- c("1G","1H","2C","S2A","S2B","S6A","S6B","ED_8B")
