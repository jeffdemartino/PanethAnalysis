...
#'   \item \strong{Figure 3D}: Violin plots depicting normalized gene
#'   expression of HES1, CDX1, ANPEP and CYP3A4 between cells cultured in IL22+ and
...
#' @param figure ID of the figure to be reproduced. Accepted values are "2D","3D",
...
plot_il22 <- function(object=NULL, dge.output=NA, figure=NA, save=FALSE, save.dir="."){
  ...
  # Check inputs
  accept.figs <- c("2D","3A","ED_9A","ED_9B")
