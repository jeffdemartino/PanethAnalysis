...
#' @param figure ID of the figure to be reproduced. Accepted values are "1G",
#'   "1H", "2C", "S2A", "S2B", "S6A", "S6B" and "S7A" (See Details for
#'   description of figure panels)
#' @param save Whether to save the specified plot as a pdf (default = FALSE)
...
plot_il22 <- function(object=NULL, dge.output=NA, figure=NA, save=FALSE, save.dir="."){
  ...
  if (figure == "S7D"){
    ...
    IL_topgenes_plot <- StackedVlnPlot(obj = object, features = IL_topgenes, split.by = "condition", cols = condition.cols, group.by = "Final.IDS") +
...
plot_trajectory <- function(seurat.obj = NULL, slingshot.obj = NULL, figure = NA, save=FALSE, save.dir="."){
  ...
  if (figure == "S3C"){
    ...
    plot.ec <- ggplot2::ggplot(data$ec, ggplot2::aes(x=DC_1, y=DC_2)) +
      ...
      ggplot2::xlab("DC 1") +
      ggplot2::ylab("DC 2") +
      ggplot2::geom_line(data=slingshot::slingCurves(slingshot$ec,as.df=T),
    ...
    plot.sec <- ggplot2::ggplot(data$secretory, ggplot2::aes(x=DC_1, y=DC_2)) +
      ...
      ggplot2::xlab("DC 1") +
      ggplot2::ylab("DC 2") +
      ggplot2::geom_line(data=slingshot::slingCurves(slingshot$secretory,as.df=T),
                         ggplot2::aes(x=DC_1,y=DC_2,group=Lineage),color="grey")
    ...
    plot.paneth <- ggplot2::ggplot(data$paneth, ggplot2::aes(x=DC_1, y=DC_2)) +
      ...
      ggplot2::xlab("DC 1") +
      ggplot2::ylab("DC 2") +
      ggplot2::geom_line(data=slingshot::slingCurves(slingshot$paneth,as.df=T),
                         ggplot2::aes(x=DC_1,y=DC_2,group=Lineage),color="grey")
